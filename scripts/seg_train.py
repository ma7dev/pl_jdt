...
# modules
from pl_jdt.pl.modules.seg_module import LitModule
from pl_jdt.pl.datasets.penn_fudan import LitDataset
...
def main(cfg : DictConfig) -> None:
    ...
    data_path = f"{cfg.project.root_dir}/{cfg.project.data_dir}/PennFudanPed"
